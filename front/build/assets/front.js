...
define('front/controllers/index', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    ...
    occurrences: _ember['default'].computed('model.@each', function () {
    ...
    userList: _ember['default'].computed('users.@each', function () {
      var ar = [];
      var _this = this;
...
define('front/routes/index', ['exports', 'ember', 'ember-simple-auth/mixins/authenticated-route-mixin', 'ember-can'], function (exports, _ember, _emberSimpleAuthMixinsAuthenticatedRouteMixin, _emberCan) {
	exports['default'] = _ember['default'].Route.extend(_emberCan.CanMixin, _emberSimpleAuthMixinsAuthenticatedRouteMixin['default'], {
   ...
   */
		...
		actions: {
			loadData: function loadData(userId) {
				this.get('controller').set('model', this.store.query('event', { owner: userId }));
			},
			loadSeccionals: function loadSeccionals(userId) {
...
define("front/templates/events/show", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "mXWhVII/", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"section-content home ui segment tall stacked\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"field\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"label\",[]],[\"flush-element\"],[\"text\",\"\\n        \"],[\"append\",[\"unknown\",[\"model\",\"owner\",\"lastName\"]],false],[\"text\",\"           \\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"field\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"label\",[]],[\"flush-element\"],[\"text\",\"\\n\\t\\t    \"],[\"append\",[\"unknown\",[\"model\",\"title\"]],false],[\"text\",\"\\t\\t        \\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"field\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"label\",[]],[\"flush-element\"],[\"text\",\"\\n        \"],[\"append\",[\"unknown\",[\"description\"]],true],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"field\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"label\",[]],[\"flush-element\"],[\"text\",\"\\n        Fecha Inicio  \"],[\"append\",[\"unknown\",[\"model\",\"startDate\"]],false],[\"text\",\"    \\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"label\",[]],[\"flush-element\"],[\"text\",\"\\n        Fecha Fin \"],[\"append\",[\"unknown\",[\"model\",\"endDate\"]],false],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"      \\n    \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"field\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"label\",[]],[\"flush-element\"],[\"text\",\"\\n        Direccion / Lugar\\n        \"],[\"append\",[\"unknown\",[\"model\",\"address\"]],false],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\\n    \"],[\"append\",[\"helper\",[\"g-maps\"],null,[[\"name\",\"lat\",\"lng\",\"zoom\",\"markers\"],[\"my-map\",[\"get\",[\"lat\"]],[\"get\",[\"lng\"]],[\"get\",[\"zoom\"]],[\"get\",[\"markers\"]]]]],false],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"helper\",[\"can\"],[\"view admin\"],null]],null,2],[\"text\",\"\\n\"],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"        Hacer seccional\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"        Seccional\\n\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"if\"],[[\"get\",[\"model\",\"goblal\"]]],null,1,0]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "front/templates/events/show.hbs" } });
});
define("front/templates/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "XQUUFM56", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"ui container segment\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"actions\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"block\",[\"link-to\"],[\"events.new\"],[[\"classNames\"],[\"ui orange button tiny\"]],2],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\\n\\n  \"],[\"append\",[\"helper\",[\"as-calendar\"],null,[[\"title\",\"occurrences\",\"defaultTimeZoneQuery\",\"dayStartingTime\",\"dayEndingTime\",\"timeSlotDuration\",\"editable\",\"onAddOccurrence\",\"onUpdateOccurrence\",\"onRemoveOccurrence\"],[\"Eventos\",[\"get\",[\"occurrences\"]],\"Buenos Aires\",\"7:00\",\"18:00\",\"00:30\",false,[\"helper\",[\"action\"],[[\"get\",[null]],\"calendarAddOccurrence\"],null],[\"helper\",[\"action\"],[[\"get\",[null]],\"calendarUpdateOccurrence\"],null],[\"helper\",[\"action\"],[[\"get\",[null]],\"calendarRemoveOccurrence\"],null]]]],false],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"block\",[\"if\"],[[\"helper\",[\"can\"],[\"view admin\"],null]],null,1]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"        \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"class\",\"ui button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"loadData\",[\"get\",[\"user\",\"id\"]]]],[\"flush-element\"],[\"append\",[\"unknown\",[\"user\",\"lastName\"]],false],[\"close-element\"],[\"text\",\" \\n\"]],\"locals\":[\"user\"]},{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"ui container segment\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"ui buttons\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"class\",\"ui button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"loadSeccionals\"]],[\"flush-element\"],[\"text\",\"Seccionales\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"userList\"]]],null,0],[\"text\",\"    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Crear nuevo evento\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "front/templates/index.hbs" } });
});
...
if (!runningTests) {
  require("front/app")["default"].create({"name":"front","version":"0.0.0+71dcebb5"});
}
